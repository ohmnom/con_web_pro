...
<security:authorize ifAnyGranted="ROLE_MAKER,ROLE_CHECKER">
	<%
...
<body>
	<br>
	<div align="center">
		<img src="<c:url value="/resources/css/nucPic.png" />" alt="not images"
	...
	<form action="j_spring_security_check" method="post"
		...
		<div class="form-group">
			<label class="control-label col-sm-5">Enter User ID :</label>
			<div class="col-sm-3">
			...
			<div class="col-sm-3">
				<div class="input-group">
					<span class="input-group-addon"><i
						...
						name="j_password" class="form-control" required="required "
		...
		<div class="form-group text-center">
			<div class="checkbox">
				    <label><input type="checkbox" tabindex="3"
					name="jsfspring-sec" checked="checked"> Remember me</label>  
			</div>
		</div>

		<div align="center">
			<input type="submit" class="btn btn-md" value="Login"
				style="background-color: #cc3300; color: #ffffff">
		</div>
	</form>
	...
	<svg id="svg-source" height="0" version="1.1"
		...
		xmlns:xlink="http://www.w3.org/1999/xlink"> <g id="git"
		data-iconmelon="Iconmelon:c88d710192f240e49b7f92912997850e"> <path
		fill="#40B7AE"
		d="M16.176,31.751c4.82,0,8.764-3.196,9.08-7.242H7.096C7.413,28.555,11.355,31.751,16.176,31.751z"></path>
	<g opacity="0.1"> <path fill="#FFFFFF"
	...
	<g id="_x23_c49b86ff"> <path fill="#C49C87"
	...
	</g> <g id="_x23_f4cab1ff"> <path fill="#F4CBB2"
	...
	</g> <g id="_x23_ffffffff"> <path fill="#FFFFFF"
	...
	</g> <g id="_x23_ac5c51ff"> <path fill="#3C3C3B"
